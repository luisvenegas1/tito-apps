...
import { availableCategories, filterApps } from "@/utils/filterApps";

export function HomePage() {
  const [query, setQuery] = useState("");
  const [category, setCategory] = useState<AppCategory | "all">("all");
  const filtered = useMemo(() => filterApps(apps, query, category), [query, category]);
