...
FUNCTIONS=(login analyze-food analyze-scale analyze-label coach meal-plan parse-meal-text send-reminders strava-exchange strava-sync device-exchange device-sync)
